...
export const LEVELS: LevelConfig[] = [
  // ─── Level 1: The Basics ──────────────────────────────────────
  {
    ...
    fixedPegs: galtonPegs(8, 80, 50, 42, 200),
    moveablePegs: [
      { x: 120, y: 200 },
      { x: 280, y: 200 },
      { x: 200, y: 350 },
  ...
  // ─── Level 4: The Funnel ──────────────────────────────────────
  {
    ...
    fixedPegs: [
      // Outer V-shape walls for natural funneling
      { x: 60, y: 100 },  { x: 340, y: 100 },
      { x: 70, y: 160 },  { x: 330, y: 160 },
      { x: 80, y: 220 },  { x: 320, y: 220 },
      { x: 90, y: 280 },  { x: 310, y: 280 },
      { x: 100, y: 340 }, { x: 300, y: 340 },
      { x: 110, y: 400 }, { x: 290, y: 400 },
      // Top scatter row
      { x: 150, y: 90 },
      { x: 200, y: 80 },
      { x: 250, y: 90 },
  ...
  // ─── Level 5: Uniform Spread ──────────────────────────────────
  {
    ...
    fixedPegs: [
      // Evenly spaced grid to give structure without bias
      { x: 200, y: 80 },
      { x: 120, y: 140 }, { x: 280, y: 140 },
      { x: 60, y: 210 },  { x: 200, y: 210 }, { x: 340, y: 210 },
      { x: 100, y: 290 }, { x: 200, y: 290 }, { x: 300, y: 290 },
      { x: 60, y: 370 },  { x: 340, y: 370 },
      { x: 120, y: 440 }, { x: 280, y: 440 },
    ],
    moveablePegs: [
      { x: 150, y: 140 },
      { x: 250, y: 140 },
  ...
  // ─── Level 6: Zigzag ──────────────────────────────────────────
  {
    ...
    fixedPegs: [
      // Dense zigzag scaffold — alternating rows offset horizontally
      { x: 100, y: 90 },  { x: 200, y: 90 },  { x: 300, y: 90 },
      { x: 60, y: 150 },  { x: 150, y: 150 }, { x: 250, y: 150 }, { x: 340, y: 150 },
      { x: 100, y: 210 }, { x: 200, y: 210 }, { x: 300, y: 210 },
      { x: 60, y: 270 },  { x: 150, y: 270 }, { x: 250, y: 270 }, { x: 340, y: 270 },
      { x: 100, y: 340 }, { x: 200, y: 340 }, { x: 300, y: 340 },
      { x: 60, y: 410 },  { x: 150, y: 410 }, { x: 250, y: 410 }, { x: 340, y: 410 },
    ],
    moveablePegs: [
      { x: 110, y: 120 },
      { x: 200, y: 120 },
  ...
  // ─── Level 7: The Wall ────────────────────────────────────────
  {
    ...
    fixedPegs: [
      // Top galton-like rows
      { x: 200, y: 80 },
      { x: 160, y: 130 }, { x: 240, y: 130 },
      { x: 120, y: 180 }, { x: 200, y: 180 }, { x: 280, y: 180 },
      // Dense wall — two staggered rows
      { x: 50, y: 260 },  { x: 90, y: 260 },  { x: 130, y: 260 },
      { x: 170, y: 260 }, { x: 210, y: 260 }, { x: 250, y: 260 },
      { x: 290, y: 260 }, { x: 330, y: 260 }, { x: 360, y: 260 },
      { x: 70, y: 290 },  { x: 110, y: 290 }, { x: 150, y: 290 },
      { x: 190, y: 290 }, { x: 230, y: 290 }, { x: 270, y: 290 },
      { x: 310, y: 290 }, { x: 350, y: 290 },
    ],
    moveablePegs: [
      { x: 200, y: 220 },
      { x: 150, y: 380 },
